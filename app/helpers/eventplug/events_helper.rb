module Eventplug
  module EventsHelper
    ...
    def twitter_button_url
      text = I18n.t('eventplug.events.social_media.twitter_link', :url => CGI.escape(request.original_url))
     "https://twitter.com/intent/tweet?text=#{text}"
    end

    def facebook_button_url
      url = CGI.escape(request.original_url)
      text = I18n.t('eventplug.events.social_media.facebook_link', :url => url)
